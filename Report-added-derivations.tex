...
These summaries have been written by users of the popular online movie database IMDb, with the intent to outline the events that occur in the movie to the reader.

This is fundamentally different from movie reviews, as the author is not supposed to inject his or her own opinion of the movie in the summary.
However, this can obviously never be fully accomplished, since the author must have a opinion on the movie in question.
